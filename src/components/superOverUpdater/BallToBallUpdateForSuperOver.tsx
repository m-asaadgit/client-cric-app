...
function BallToBallUpdateForSuperOver({
  firstInning,
  batter,
  bowler,
  feilderPlayers,
  ...
  console.log(batter  && batter,"babab" );
  const [dropFordismissalType, setDropFordismissalType] =
    useState<boolean>(false);
  const [ballToBallURL, setBallToBallURL] =
    useState<string>("http://localhost:3000/api/unlisted-match/super-over-ball-update/");
...
export default BallToBallUpdateForSuperOver;
